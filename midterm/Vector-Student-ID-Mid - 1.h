...
public:
      ...
      : myData()
   {
      if( count != 0 )
      {
          ...
          myData.myFirst = myData.myFirst + count;
   ...
   iterator insert( const_iterator where, const value_type &val )
   {
      ...
      {
          int newSize = size() + 1, i, n = myData.myLast - where;
          ...
          if (newSize <= capacity())
          {
              ...
              myData.myFirst[i] = val;  //i increases by one and breaks the for loop

              myData.myLast = myData.myFirst + newSize;
          }
          else if (newSize > capacity())
          {
              size_type newcapacity = capacity() * 1.5;
              if (newSize > newcapacity)
                  newcapacity = newSize;

              pointer v1 = myData.myFirst;
