...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger< T > &op2 )
{
   ...
   typename vector< T >::iterator it = buffer.integer.end() - 1;
...
<body>
    <form method="post" action="./File_DownLoad_Wk_zip.aspx?File_name=HugeInteger+-+1081517+-+hw5-1.h&amp;type=3&amp;id=2909420" id="form1">
