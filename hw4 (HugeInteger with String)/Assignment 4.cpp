...
int main()
{
   ...
   for( int i = 0; i < numTestCases; i++ )  //輸出到黑窗
   ...
   for( int i = 0; i < numTestCases; i++ )  //印出到檔案
...
void print( ostream &outFile, HugeInteger n1, HugeInteger n2 )  //outfile參考cout物件，使outfile變成cout的別名
{
   outFile << n1 << endl;
   outFile << n2 << endl;
